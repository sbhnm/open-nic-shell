...
resize_pblock [get_pblocks {pblock_gnblk2[0].spmv_clc_krnl_1}] -add {CLOCKREGION_X0Y1:CLOCKREGION_X0Y3}
...
resize_pblock [get_pblocks {pblock_gnblk2[1].spmv_clc_krnl_1}] -add {CLOCKREGION_X1Y1:CLOCKREGION_X1Y3}
...
resize_pblock [get_pblocks {pblock_gnblk2[2].spmv_clc_krnl_1}] -add {CLOCKREGION_X2Y1:CLOCKREGION_X2Y3}
...
resize_pblock [get_pblocks {pblock_gnblk2[3].spmv_clc_krnl_1}] -add {CLOCKREGION_X3Y1:CLOCKREGION_X3Y3}
